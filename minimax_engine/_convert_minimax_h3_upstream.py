# Vendored verbatim from huggingface/diffusers#14355 @ abc5e9b
# (scripts/convert_minimax_h3_to_diffusers.py). Run through convert_checkpoint.py, which
# aliases the PR-only diffusers import onto the vendored minimax_video classes.
