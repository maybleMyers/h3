...
#
# Ported from huggingface/diffusers#14355 @ e1b518d (autoencoder_kl_minimax_h3.py) for H1111.
...
class AutoencoderMixin:
    ...
    Only the members this file actually inherits: the enable/disable toggles for tiling and
    slicing. `enable_tiling` is overridden by the autoencoder class below.
    """
